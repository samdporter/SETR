...
from recon_core.utils.sirf import get_array, get_pet_am
...
def run_shift_checks(
    ...
    from recon_core.cil_extensions.operators import ImageCombineOperator, AdjointOperator as _AdjointOperator
