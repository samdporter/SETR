...
def get_kernel_hyperparams(args):
    ...
    return {
        ...
        "sigma_dist_an": args.sigma_distance_anatomical,
        "sigma_dist_em": args.sigma_distance_emission,
...
def run_ista(args, data, guidance, hyperparams):
    ...
    K = STIRKernelOperator(
        ...
        sigma_m=hyperparams["sigma_anat"],
        sigma_p=hyperparams["sigma_emission"],
        sigma_dm=hyperparams["sigma_dist_an"],
        sigma_dp=hyperparams["sigma_dist_em"],
